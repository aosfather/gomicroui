// Code generated from atlas.inl. DO NOT EDIT.
package main

import "microui"

// Atlas constants. Mirror the C enum in atlas.inl.
const (
	AtlasWhite  = microui.IconMax
	AtlasFont   = microui.IconMax + 1
	AtlasWidth  = 128
	AtlasHeight = 128
)

// atlasTexture is the raw 128x128 alpha texture.
var atlasTexture = [16384]byte{
...
// atlas maps an icon/font index to a sub-rect within atlasTexture.
// Populated in init() since Go lacks designated initializers with
// computed indices.
var atlas = make([]microui.Rect, AtlasFont+128)

func init() {
	atlas[microui.IconClose] = microui.NewRect(88, 68, 16, 16)
	atlas[microui.IconCheck] = microui.NewRect(0, 0, 18, 18)
	atlas[microui.IconExpanded] = microui.NewRect(118, 68, 7, 5)
	atlas[microui.IconCollapsed] = microui.NewRect(113, 68, 5, 7)
	atlas[AtlasWhite] = microui.NewRect(125, 68, 3, 3)
	atlas[AtlasFont+32] = microui.NewRect(84, 68, 2, 17)
	atlas[AtlasFont+33] = microui.NewRect(39, 68, 3, 17)
	atlas[AtlasFont+34] = microui.NewRect(114, 51, 5, 17)
	atlas[AtlasFont+35] = microui.NewRect(34, 17, 7, 17)
	atlas[AtlasFont+36] = microui.NewRect(28, 34, 6, 17)
	atlas[AtlasFont+37] = microui.NewRect(58, 0, 9, 17)
	atlas[AtlasFont+38] = microui.NewRect(103, 0, 8, 17)
	atlas[AtlasFont+39] = microui.NewRect(86, 68, 2, 17)
	atlas[AtlasFont+40] = microui.NewRect(42, 68, 3, 17)
	atlas[AtlasFont+41] = microui.NewRect(45, 68, 3, 17)
	atlas[AtlasFont+42] = microui.NewRect(34, 34, 6, 17)
	atlas[AtlasFont+43] = microui.NewRect(40, 34, 6, 17)
	atlas[AtlasFont+44] = microui.NewRect(48, 68, 3, 17)
	atlas[AtlasFont+45] = microui.NewRect(51, 68, 3, 17)
	atlas[AtlasFont+46] = microui.NewRect(54, 68, 3, 17)
	atlas[AtlasFont+47] = microui.NewRect(124, 34, 4, 17)
	atlas[AtlasFont+48] = microui.NewRect(46, 34, 6, 17)
	atlas[AtlasFont+49] = microui.NewRect(52, 34, 6, 17)
	atlas[AtlasFont+50] = microui.NewRect(58, 34, 6, 17)
	atlas[AtlasFont+51] = microui.NewRect(64, 34, 6, 17)
	atlas[AtlasFont+52] = microui.NewRect(70, 34, 6, 17)
	atlas[AtlasFont+53] = microui.NewRect(76, 34, 6, 17)
	atlas[AtlasFont+54] = microui.NewRect(82, 34, 6, 17)
	atlas[AtlasFont+55] = microui.NewRect(88, 34, 6, 17)
	atlas[AtlasFont+56] = microui.NewRect(94, 34, 6, 17)
	atlas[AtlasFont+57] = microui.NewRect(100, 34, 6, 17)
	atlas[AtlasFont+58] = microui.NewRect(57, 68, 3, 17)
	atlas[AtlasFont+59] = microui.NewRect(60, 68, 3, 17)
	atlas[AtlasFont+60] = microui.NewRect(106, 34, 6, 17)
	atlas[AtlasFont+61] = microui.NewRect(112, 34, 6, 17)
	atlas[AtlasFont+62] = microui.NewRect(118, 34, 6, 17)
	atlas[AtlasFont+63] = microui.NewRect(119, 51, 5, 17)
	atlas[AtlasFont+64] = microui.NewRect(18, 0, 10, 17)
	atlas[AtlasFont+65] = microui.NewRect(41, 17, 7, 17)
	atlas[AtlasFont+66] = microui.NewRect(48, 17, 7, 17)
	atlas[AtlasFont+67] = microui.NewRect(55, 17, 7, 17)
	atlas[AtlasFont+68] = microui.NewRect(111, 0, 8, 17)
	atlas[AtlasFont+69] = microui.NewRect(0, 35, 6, 17)
	atlas[AtlasFont+70] = microui.NewRect(6, 35, 6, 17)
	atlas[AtlasFont+71] = microui.NewRect(119, 0, 8, 17)
	atlas[AtlasFont+72] = microui.NewRect(18, 17, 8, 17)
	atlas[AtlasFont+73] = microui.NewRect(63, 68, 3, 17)
	atlas[AtlasFont+74] = microui.NewRect(66, 68, 3, 17)
	atlas[AtlasFont+75] = microui.NewRect(62, 17, 7, 17)
	atlas[AtlasFont+76] = microui.NewRect(12, 51, 6, 17)
	atlas[AtlasFont+77] = microui.NewRect(28, 0, 10, 17)
	atlas[AtlasFont+78] = microui.NewRect(67, 0, 9, 17)
	atlas[AtlasFont+79] = microui.NewRect(76, 0, 9, 17)
	atlas[AtlasFont+80] = microui.NewRect(69, 17, 7, 17)
	atlas[AtlasFont+81] = microui.NewRect(85, 0, 9, 17)
	atlas[AtlasFont+82] = microui.NewRect(76, 17, 7, 17)
	atlas[AtlasFont+83] = microui.NewRect(18, 51, 6, 17)
	atlas[AtlasFont+84] = microui.NewRect(24, 51, 6, 17)
	atlas[AtlasFont+85] = microui.NewRect(26, 17, 8, 17)
	atlas[AtlasFont+86] = microui.NewRect(83, 17, 7, 17)
	atlas[AtlasFont+87] = microui.NewRect(38, 0, 10, 17)
	atlas[AtlasFont+88] = microui.NewRect(90, 17, 7, 17)
	atlas[AtlasFont+89] = microui.NewRect(30, 51, 6, 17)
	atlas[AtlasFont+90] = microui.NewRect(36, 51, 6, 17)
	atlas[AtlasFont+91] = microui.NewRect(69, 68, 3, 17)
	atlas[AtlasFont+92] = microui.NewRect(124, 51, 4, 17)
	atlas[AtlasFont+93] = microui.NewRect(72, 68, 3, 17)
	atlas[AtlasFont+94] = microui.NewRect(42, 51, 6, 17)
	atlas[AtlasFont+95] = microui.NewRect(15, 68, 4, 17)
	atlas[AtlasFont+96] = microui.NewRect(48, 51, 6, 17)
	atlas[AtlasFont+97] = microui.NewRect(54, 51, 6, 17)
	atlas[AtlasFont+98] = microui.NewRect(97, 17, 7, 17)
	atlas[AtlasFont+99] = microui.NewRect(0, 52, 5, 17)
	atlas[AtlasFont+100] = microui.NewRect(104, 17, 7, 17)
	atlas[AtlasFont+101] = microui.NewRect(60, 51, 6, 17)
	atlas[AtlasFont+102] = microui.NewRect(19, 68, 4, 17)
	atlas[AtlasFont+103] = microui.NewRect(66, 51, 6, 17)
	atlas[AtlasFont+104] = microui.NewRect(111, 17, 7, 17)
	atlas[AtlasFont+105] = microui.NewRect(75, 68, 3, 17)
	atlas[AtlasFont+106] = microui.NewRect(78, 68, 3, 17)
	atlas[AtlasFont+107] = microui.NewRect(72, 51, 6, 17)
	atlas[AtlasFont+108] = microui.NewRect(81, 68, 3, 17)
	atlas[AtlasFont+109] = microui.NewRect(48, 0, 10, 17)
	atlas[AtlasFont+110] = microui.NewRect(118, 17, 7, 17)
	atlas[AtlasFont+111] = microui.NewRect(0, 18, 7, 17)
	atlas[AtlasFont+112] = microui.NewRect(7, 18, 7, 17)
	atlas[AtlasFont+113] = microui.NewRect(14, 34, 7, 17)
	atlas[AtlasFont+114] = microui.NewRect(23, 68, 4, 17)
	atlas[AtlasFont+115] = microui.NewRect(5, 52, 5, 17)
	atlas[AtlasFont+116] = microui.NewRect(27, 68, 4, 17)
	atlas[AtlasFont+117] = microui.NewRect(21, 34, 7, 17)
	atlas[AtlasFont+118] = microui.NewRect(78, 51, 6, 17)
	atlas[AtlasFont+119] = microui.NewRect(94, 0, 9, 17)
	atlas[AtlasFont+120] = microui.NewRect(84, 51, 6, 17)
	atlas[AtlasFont+121] = microui.NewRect(90, 51, 6, 17)
	atlas[AtlasFont+122] = microui.NewRect(10, 68, 5, 17)
	atlas[AtlasFont+123] = microui.NewRect(31, 68, 4, 17)
	atlas[AtlasFont+124] = microui.NewRect(96, 51, 6, 17)
	atlas[AtlasFont+125] = microui.NewRect(35, 68, 4, 17)
	atlas[AtlasFont+126] = microui.NewRect(102, 51, 6, 17)
	atlas[AtlasFont+127] = microui.NewRect(108, 51, 6, 17)
}
